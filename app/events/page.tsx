...
import { GET_EVENT_TEASERS } from '@/lib/queries'
import { EventListData } from '@/lib/types'
...
async function getEvents() {
  try {
    ...
    const { data } = await apolloClient.query<EventListData>({
      query: GET_EVENT_TEASERS,
      variables: { first: 50 },
