...
import { GET_NEWS_TEASERS } from '@/lib/queries'
import { NewsListData } from '@/lib/types'
...
async function getNews() {
  try {
    ...
    const { data } = await apolloClient.query<NewsListData>({
      query: GET_NEWS_TEASERS,
      variables: { first: 50 },
