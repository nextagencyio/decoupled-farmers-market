...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Contact Riverside Farmers Market. We\'d love to hear from you about vendor applications, market schedules, or sponsorship.',
  keywords: ['Contact Riverside Farmers Market', 'Support', 'Help', 'Get in Touch'],
}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-base md:text-lg text-gray-600">
              Have questions about vendor applications, market schedules, or sponsorship? We&#39;d love to hear from you.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@riversidefarmersmarket.org</p>
                    <p className="text-gray-600">support@riversidefarmersmarket.org</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">(555) 345-6708</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Market Days: Saturday 8:00 AM - 1:00 PM<br />
